...
const UpdateAddressPage = ({ params }) => {
  ...
  const onSubmit = (data) => {
    ...
    fetch(`http://localhost:3000/api/user-address/${params.email}`, {
      method: "PUT",
      headers: {
    ...
    <div className=" overflow-hidden">
      <MaxWidthWrapper>
        <div className="my-10 font">
          <p className="text-sm mb-6">update your billing address</p>
...
export default dynamic(() => Promise.resolve(UpdateAddressPage), { ssr: false });
